...
# Événement qui s'exécute quand le bot est prêt
@bot.event
async def on_ready():
    print(f'Bot connecté en tant que {bot.user.name}')

# Événement qui s'exécute quand un message est envoyé
@bot.event
async def on_message(message):
    ...
    # Permet au bot de traiter les commandes
